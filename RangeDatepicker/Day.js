	...
	render() {
		...
		switch(day.type){
			case "single" : 
				...
				break;
			case "first" :
				dayStyle = {backgroundColor : dayProps.startDateBackgroundColor, borderRadius: Math.floor(DEVICE_WIDTH / 7), width: "14.28%" }
				textDayStyle = {color: dayProps.selectedTextColor};
				break;
			case "last" :
				dayStyle = {backgroundColor : dayProps.endDateBackgroundColor, borderRadius: Math.floor(DEVICE_WIDTH / 7), width: "14.28%" }
				textDayStyle = {color: dayProps.selectedTextColor};
				break;
			case "between" :
